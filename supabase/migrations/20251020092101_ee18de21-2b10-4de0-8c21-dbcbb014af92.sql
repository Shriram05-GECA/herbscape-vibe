...
-- Insert sample herbs data with working image URLs
-- Insert sample herbs data with verified direct image URLs
-- Insert sample herbs data with verified direct image URLs
